...
class Del(Resource):
    def get(self):
        dir_name = "C:/Users/Ashwani/Angular_Workspace"
...
class Employees(Resource):
    def get(self):
        ...
        dfcomp = yf.download(['AAPL', 'GE', 'GOOG', 'IBM', 'MSFT'],start, end)['Adj Close']
        ...
        result=[]
        #Define Variables
        S = yf.download(company, start, end)['Adj Close'][-1]#apple['Adj Close'][-1] #starting stock price (i.e. last available real stock price)
